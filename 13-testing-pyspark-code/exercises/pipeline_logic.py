"""
A small quality-gate function (Module 12 style) for exercise_02.py to write tests
against. Not part of the exercise itself -- the function is already implemented;
your job in exercise_02.py is to write GOOD TESTS for it, including its edge cases.
"""
